...
This client-only bundle contains three environments:
...
It contains no application source, source build contexts, Gamestory build environment, or Gamestory release environment. Application images are pulled from Docker Hub. Keycloak is pulled from Quay at a pinned digest.
